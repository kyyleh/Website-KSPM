    ...
    <div className="w-full space-y-5 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-3.5">
          ...
          <div className="bg-white border border-[#eae6dd] rounded-xl p-4 shadow-sm">
            <h3 className="font-script text-[10px] text-[#a67e2a] font-bold tracking-[0.12em] mb-3">Header Halaman</h3>
            <div className="flex flex-col md:flex-row gap-4">
              <div className="flex-1 space-y-3.5">
                ...
                <div>
                  ...
                  <textarea value={data.eventsHeaderDescription || ''} onChange={(e) => { setIsDirty?.(true); setData(prev => ({ ...prev, eventsHeaderDescription: e.target.value })); }} rows={3} className="w-full text-xs bg-[#faf9f5] border-b border-[#d2cbbe] hover:border-[#a67e2a] focus:border-[#a67e2a] px-2 py-1.5 focus:bg-white transition-all outline-none rounded-t duration-200 text-[#1c1515] resize-none" />
                </div>
              </div>
              <div className="w-full md:w-auto md:shrink-0 flex justify-start md:justify-end">
                <ImageUploader label="Gambar Header" value={data.eventsHeaderImage || ''} onChange={(url) => { setIsDirty?.(true); setData(prev => ({ ...prev, eventsHeaderImage: url })); }} />
              </div>
            </div>
          </div>
