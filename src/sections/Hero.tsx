...
export function Hero({ data, onNavigate }: { isReady?: boolean; data?: typeof heroConfig; onNavigate?: (page: string) => void }) {
  ...
  return (
    ...
    >
      {/* Abstract background gradient overlays */}
      ...
      <div className="container-custom relative z-10 flex-grow grid grid-cols-12 gap-4 sm:gap-8 lg:gap-16 items-center w-full">
        ...
        >
          ...
          <div className="flex flex-wrap gap-2 sm:gap-4 mt-1 sm:mt-2">
            ...
            <button
              onClick={() => onNavigate ? onNavigate('#contact') : scrollToSection('#contact')}
