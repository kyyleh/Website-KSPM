        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              ...
              <div>
                <span className="font-serif text-3xl md:text-4xl text-white tracking-wide block">{footerConfig.brandName}</span>
                {footerConfig.tagline && (
                  <span className="text-xs md:text-sm text-gold-400 tracking-widest uppercase mt-1 block">{footerConfig.tagline}</span>
                )}
              </div>
            </div>
          ...
          <div>
            {footerConfig.contactItems.length > 0 && (
              <>
                <h3 className="font-serif text-lg text-white mb-5">Kontak</h3>
